export const landingPageStyles = {
  ...
  // Header styles
  header:
    'fixed top-0 w-full z-50 bg-white/90 backdrop-blur-xl border-b border-emerald-100',
  headerContainer:
    'max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-3 flex justify-between items-center',
  logoContainer: 'flex items-center gap-3',
  logoIcon:
    'w-10 h-10 bg-gradient-to-br from-emerald-500 to-teal-600 rounded-xl flex items-center justify-center shadow-md shadow-emerald-100/50',
  logoIconInner: 'w-5 h-5 text-white',
  logoText:
    'text-xl sm:text-2xl font-bold bg-gradient-to-r from-emerald-600 to-teal-700 bg-clip-text text-transparent tracking-tight',
  mobileMenuButton:
    'md:hidden p-2 rounded-lg hover:bg-emerald-50/80 transition-colors duration-200',
  mobileMenuIcon: 'text-emerald-700',

  // Auth buttons - Green gradient version
  desktopAuthButton:
    'relative group px-6 sm:px-8 py-2 sm:py-3 bg-gradient-to-r from-emerald-500 to-teal-600 text-white font-bold rounded-2xl overflow-hidden transition-all hover:scale-105 hover:shadow-xl hover:shadow-emerald-200',
  desktopAuthButtonText: 'relative',
  desktopAuthButtonOverlay:
    'absolute inset-0 bg-gradient-to-r from-teal-600 to-emerald-500 opacity-0 group-hover:opacity-100 transition-opacity',
  mobileAuthButton:
    'w-full px-6 py-3 bg-gradient-to-r from-emerald-500 to-teal-600 text-white font-bold rounded-2xl',
  // Mobile menu
  // Mobile menu
  // Mobile menu
  mobileMenu:
    'md:hidden bg-white/95 backdrop-blur-lg w-full fixed top-16 left-0 right-0 z-40 shadow-lg border-b border-emerald-100/50 transition-all duration-300 ease-in-out',
  mobileMenuContainer:
    'max-w-6xl mx-auto px-4 sm:px-6 py-4 flex flex-col gap-4',
  mobileUserInfo: 'flex flex-col gap-4 py-2',
  mobileUserWelcome:
    'text-emerald-700 font-medium text-center py-2 text-base sm:text-lg',
  mobileDashboardButton:
    'w-full px-6 py-3 bg-gradient-to-r from-emerald-500 to-teal-600 text-white font-bold rounded-xl hover:shadow-lg hover:shadow-emerald-200/50 transition-all',
  mobileAuthButton:
    'w-full px-6 py-3 bg-gradient-to-r from-emerald-500 to-teal-600 text-white font-bold rounded-xl hover:shadow-lg hover:shadow-emerald-200/50 transition-all',
  // Main content
  main: 'pt-24',
  ...
  heroLeft: 'space-y-8',
  tagline:
    'inline-flex items-center gap-2 sm:gap-3 px-4 py-2 bg-gradient-to-r from-emerald-100 to-teal-100 border border-emerald-200 text-emerald-700 rounded-full font-bold text-xs sm:text-sm',
  heading: 'text-4xl sm:text-6xl lg:text-8xl font-black leading-tight',
  headingText: 'block text-slate-900',
  headingGradient:
    'block bg-gradient-to-r from-emerald-500 via-teal-500 to-green-500 bg-clip-text text-transparent',
  headingGradients:
    'block bg-gradient-to-r from-emerald-500 via-teal-500 to-green-500 bg-clip-text text-transparent px-1 -mx-1 bg-[length:200%_auto] animate-gradient-shift',
  description:
  ...
  // Buttons
  primaryButton:
    'group relative px-8 sm:px-10 py-3 sm:py-4 bg-gradient-to-r from-emerald-500 to-teal-600 text-white font-bold rounded-2xl overflow-hidden transition-all hover:scale-105 hover:shadow-xl hover:shadow-emerald-200',
  primaryButtonOverlay:
    'absolute inset-0 bg-gradient-to-r from-teal-600 to-green-500 opacity-0 group-hover:opacity-100 transition-opacity',
  primaryButtonContent:
    'relative flex justify-center items-center gap-2 sm:gap-3 px-1',
  primaryButtonIcon: 'group-hover:translate-x-1 transition-transform',
  secondaryButton:
    'group relative px-6 sm:px-8 py-2 sm:py-3 border-2 border-emerald-500 text-emerald-500 font-bold rounded-2xl overflow-hidden transition-all hover:scale-105 hover:shadow-lg hover:shadow-emerald-300',
  ...
  heroIllustrationBg:
    'absolute -inset-8 bg-gradient-to-r from-emerald-100/40 to-teal-100/40 rounded-3xl blur-xl',
  heroIllustrationContainer: 'relative z-10',

  // SVG styles
  svgContainer: 'w-full h-auto max-w-md mx-auto',
  svgRect: 'fill-[url(#cardGradient)] stroke-emerald-700 stroke-[2] opacity-40',
  svgCircle: 'fill-[url(#bgGradient)]',
  svgRectPrimary: 'fill-[#10b981] opacity-70',
  svgRectSecondary: 'fill-[#d946ef] opacity-50',
  svgRectLight: 'fill-[#e2e8f0]',
  svgRectSkill: 'fill-[#FFA500] opacity-30',
  svgAnimatedCircle: 'fill-[#10b981] opacity-80',
  svgAnimatedRect: 'fill-[#10b981] opacity-80',
  svgAnimatedPolygon: 'fill-[#10b981] opacity-80',

  // Features section
  featuresSection:
    'bg-gradient-to-br from-emerald-50 to-teal-50 py-16 sm:py-24',
  ...
  featureCardHover:
    'absolute -inset-2 bg-gradient-to-r opacity-0 group-hover:opacity-100 transition-opacity blur-xl rounded-3xl from-emerald-200 to-teal-200',
  featureCardContent:
  ...
  featureIcon: 'w-8 h-8 sm:w-10 sm:h-10 text-black',
  ...
  // Feature gradients
  featureCardEmerald: 'from-emerald-50 to-teal-50',
  featureCardTeal: 'from-teal-50 to-cyan-50',
  featureCardGreen: 'from-green-50 to-emerald-50',
  featureIconEmerald: 'from-emerald-500 to-teal-600',
  featureIconTeal: 'from-teal-500 to-cyan-600',
  featureIconGreen: 'from-green-500 to-emerald-600',
  ...
  ctaCard: 'relative',
  ctaCardBg:
    'absolute -inset-6 sm:-inset-8 bg-gradient-to-r from-emerald-200/50 to-teal-200/50 rounded-3xl blur-3xl',
  ctaCardContent:
    'relative bg-gradient-to-br from-white to-emerald-50 border border-emerald-100 rounded-3xl p-8 sm:p-16',
  ctaTitle:
    'text-3xl sm:text-4xl lg:text-5xl font-black text-slate-900 mb-4 sm:mb-6',
  ctaTitleGradient:
  ...
  ctaButton:
    'group relative px-8 sm:px-12 py-3 sm:py-5 bg-gradient-to-r from-emerald-500 to-teal-600 text-white font-black text-lg rounded-2xl overflow-hidden transition-all hover:scale-105 hover:shadow-2xl hover:shadow-emerald-200',
  ctaButtonOverlay:
    'absolute inset-0 bg-gradient-to-r from-teal-600 to-green-500 opacity-0 group-hover:opacity-100 transition-opacity',
...
export const dashboardStyles = {
  ...
  createButton:
    'group relative px-10 py-4 bg-gradient-to-r from-emerald-600 to-teal-600 text-white font-bold rounded-2xl overflow-hidden transition-all hover:scale-105 hover:shadow-2xl hover:shadow-emerald-200',
  createButtonOverlay:
    'absolute inset-0 bg-gradient-to-r from-teal-600 to-emerald-500 opacity-0 group-hover:opacity-100 transition-opacity',
  ...
  spinner:
    'animate-spin rounded-full h-12 w-12 border-t-2 border-b-2 border-emerald-600',

  // Empty State - Emerald accents
  emptyStateWrapper:
  ...
  // New Resume Card - Emerald gradient
  newResumeCard:
    'flex flex-col items-center justify-center bg-gradient-to-br from-emerald-50 to-teal-50 border-2 border-dashed border-emerald-300 rounded-2xl p-6 cursor-pointer transition-all hover:shadow-lg hover:border-emerald-500 h-full',
  newResumeIcon:
    'w-16 h-16 rounded-full bg-gradient-to-r from-emerald-600 to-teal-600 flex items-center justify-center mb-4',
...
export const cardStyles = {
  ...
  profileInitialsContainer:
    'w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-teal-500 to-orange-500 rounded-2xl flex items-center justify-center shadow-md',
  profileInitialsText: 'text-base sm:text-lg font-black text-white',
  profileName: 'text-xs sm:text-sm font-bold text-gray-800',
  logoutButton:
    'text-fuchsia-600 text-[10px] sm:text-xs font-bold cursor-pointer hover:text-orange-600 transition-colors',

  // ResumeSummaryCard styles
  resumeCard:
    'group relative h-[360px] sm:h-[380px] lg:h-[400px] flex flex-col bg-white border border-gray-200 rounded-3xl overflow-hidden cursor-pointer transition-all duration-500 hover:scale-[1.02] hover:shadow-xl hover:border-teal-300',

  cardBackground:
    'absolute inset-0 bg-gradient-to-br from-teal-100 via-transparent to-emerald-100 opacity-0 group-hover:opacity-100 transition-opacity duration-500',
  ...
  title:
    'text-sm sm:text-base font-bold text-gray-800 truncate mb-2 group-hover:text-teal-600 transition-colors',
  ...
  editButton:
    'group/btn w-12 h-12 flex items-center justify-center bg-gradient-to-r from-emerald-600 to-teal-600 rounded-2xl shadow-md hover:scale-110 transition-all duration-300',
  ...
  completionMedium: 'from-teal-400 to-emerald-500',
  completionLow: 'from-teal-500 to-green-600',

  // TemplateCard styles
  templateCard:
    'relative rounded-lg overflow-hidden shadow-md transition-all duration-300 cursor-pointer border border-gray-200',
  templateCardSelected: 'ring-2 ring-teal-500 scale-[1.02]',
  ...
  selectionCircle:
    'w-8 h-8 bg-teal-600 rounded-full flex items-center justify-center shadow-md',
...
export const authStyles = {
  container:
    'w-[90vw] md:w-[400px] p-8 bg-gradient-to-br from-white to-emerald-50 rounded-3xl border border-emerald-100 shadow-2xl',
  headerWrapper: 'text-center mb-8',
  title: 'text-2xl font-black text-slate-900 mb-2',
  subtitle: 'text-slate-600 font-medium',
  form: 'space-y-6',
  errorMessage:
    'text-rose-600 text-sm font-medium bg-rose-50 border border-rose-200 px-4 py-3 rounded-xl',
  submitButton:
    'w-full py-4 bg-gradient-to-r from-emerald-600 to-teal-600 text-white font-black rounded-2xl hover:scale-[1.02] hover:shadow-lg hover:shadow-emerald-200/50 transition-all duration-300 text-lg focus:ring-2 focus:ring-emerald-400 focus:outline-none',
  switchText: 'text-center text-sm text-slate-600 font-medium',
  switchButton:
    'font-black text-emerald-600 hover:text-teal-600 transition-colors duration-200',

  // Signup specific styles
  signupContainer:
    'w-[90vw] md:w-[400px] p-8 bg-gradient-to-br from-white to-emerald-50 rounded-3xl border border-emerald-100 shadow-2xl overflow-hidden',
  signupTitle: 'text-2xl font-black text-slate-900 mb-2',
  signupSubtitle: 'text-slate-600 font-medium',
  signupForm: 'space-y-4',
  signupSubmit:
    'w-full py-4 bg-gradient-to-r from-emerald-500 to-teal-500 text-white font-black rounded-2xl hover:scale-[1.02] hover:shadow-lg hover:shadow-emerald-200/50 transition-all duration-300 text-lg focus:ring-2 focus:ring-emerald-400 focus:outline-none',
  signupSwitchButton:
    'font-black text-emerald-600 hover:text-teal-500 transition-colors duration-200',
};
...
export const modalStyles = {
  ...
  actionButton:
    'flex items-center gap-2 px-6 py-2.5 bg-gradient-to-r from-red-500 to-red-600 text-white font-bold rounded-xl hover:scale-105 transition-all shadow-lg mr-12',
  closeButton:
    'absolute top-6 right-4 w-10 h-10 flex items-center justify-center bg-white/80 hover:bg-red-50 text-slate-400 hover:text-red-500 rounded-xl transition-all shadow-lg hover:scale-110 z-10',
  body: 'flex-3 overflow-y-auto',
};
