    ...
    >
      {thumbnailImg ? (
        <div className="relative w-full h-full overflow-hidden">
          ...
          {/* Hover Overlay */}
          <div className="absolute inset-0 bg-gradient-to-t from-teal-100/30 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
        </div>
      ) : (
        <div className="w-full h-[200px] flex flex-col items-center justify-center bg-gradient-to-br from-teal-500 via-emerald-600 to-emerald-100">
